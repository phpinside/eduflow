...
export default function TrialDealPaymentPage() {
  ...
  const handlePay = async () => {
    ...
    toast.success("成交奖励支付成功！正在跳转正课创建页面...")
  ...
  return (
    <div className="max-w-md mx-auto space-y-6 pt-8">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold">试课成交支付</h2>
        <p className="text-muted-foreground">请先支付试课成交奖励费用</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <span className="font-bold">成交奖励</span>
