...
export const mockOrders: Order[] = [
  ...
  // === 教练端课后反馈演示：同一教练（李伴学 user-tutor-1）名下多状态试课单 ===
  {
    id: 'ord-feedback-trial-assigned',
    type: OrderType.TRIAL,
    status: OrderStatus.ASSIGNED,
    ...
    assignedTeacherId: 'user-tutor-1',
    scheduledAt: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000),
    campusName: '北京海淀反馈校区（待核对）',
    campusAccount: 'hd_fb_demo_assigned',
    studentAccount: 'G_TRIAL_FB_ASSIGNED_01',
    remarks: '[反馈演示·已指派] 试课已排期待上，未到课时可先准备反馈要点',
    createdAt: new Date(Date.now() - 48 * 60 * 60 * 1000),
    updatedAt: new Date(),
  },
  {
    id: 'ord-feedback-trial-inprogress',
    type: OrderType.TRIAL,
    status: OrderStatus.IN_PROGRESS,
    ...
    campusName: '上海徐汇反馈校区',
    campusAccount: 'xh_fb_demo_run',
    studentAccount: 'G_TRIAL_FB_INPROGRESS_02',
    remarks: '[反馈演示·进行中] 今日已开课，可进行课后反馈提交演练',
    createdAt: new Date(Date.now() - 72 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 1 * 60 * 60 * 1000),
  },
  {
    id: 'ord-feedback-trial-done-pending-fb',
    type: OrderType.TRIAL,
    status: OrderStatus.COMPLETED,
    ...
    campusName: '广州天河反馈校区（待回填）',
    campusAccount: 'th_fb_demo_empty',
    studentAccount: '',
    remarks: '[反馈演示·已完成] 试课流程已完结，本条尚无课后反馈记录，列表应为空',
    createdAt: new Date(Date.now() - 96 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000),
  },
  {
    id: 'ord-feedback-trial-done-with-feedback',
    type: OrderType.TRIAL,
    status: OrderStatus.COMPLETED,
    ...
    campusName: '深圳南山反馈校区',
    campusAccount: 'ns_fb_demo_hist',
    studentAccount: 'G_TRIAL_FB_DONE_PARENT_04',
    dingbanxueAccountScreenshots: [
      'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
    ],
    remarks: '[反馈演示·已完成+家长点评] 已有一条试课后反馈及家长评价',
    createdAt: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000),
    updatedAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
  },
  {
    id: 'ord-feedback-trial-done-tutor-only',
    type: OrderType.TRIAL,
    status: OrderStatus.COMPLETED,
    ...
    campusName: '杭州西湖反馈校区',
    campusAccount: 'xh_fb_hz_demo',
    studentAccount: 'G_TRIAL_FB_TUTOR_ONLY_05',
    dingbanxueAccountScreenshots: [
      'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
    ],
    remarks: '[反馈演示·已完成·仅教练反馈] 有条试课反馈记录，暂无家长问卷点评',
