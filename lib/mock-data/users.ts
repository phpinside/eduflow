...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    wechatQrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=wxid_operator2',
  ...
  },
  {
    ...
    roles: [Role.OPERATOR],
    status: UserStatus.APPROVED,
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=operator3',
    wechatQrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=wxid_operator3',
  ...
  },
  {
    ...
    roles: [Role.OPERATOR],
    status: UserStatus.APPROVED,
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=operator4',
    wechatQrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=wxid_operator4',
  ...
  },
  {
    ...
    roles: [Role.OPERATOR],
    status: UserStatus.APPROVED,
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=operator5',
    wechatQrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=wxid_operator5',
